/*
  Link:         http://adventofcode.com/2018/day/1
...
#ifndef _2018_ADVENTOFCODE_01_CHRONAL_CALIBRATION_H_
#define _2018_ADVENTOFCODE_01_CHRONAL_CALIBRATION_H_
...
namespace aoc2018_01 {
  ...
  int solve2() {    
    ...
    while (!cin.eof()) {
        ...
        result += value;
        if (seenFrequencies.find(result) != seenFrequencies.end()) {
          return result;
        }
        seenFrequencies.insert(result);
    }
...
#endif /* _2018_ADVENTOFCODE_01_CHRONAL_CALIBRATION_H_ */
